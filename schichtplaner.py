...
FIXE_MITARBEITER = ["Martin", "Nikolaj", "Eric", "Abdullah", "Monthe", "Fabian", "Patrick", "Peter", "Marcin K.", "Daniel", "Damian", "Rene",
                    "Marcin C.", "Krzystof", "Jakub", "Radoslaw", "Vazir", "Ebrahim", "Lukasz", "Anna"", "Klaudia", "Ryzard", "Muhamad"]
